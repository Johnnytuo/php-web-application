...
if(isset($_POST['post_message'])) {
 ...
 ?>
 	...
 	<div class="profile_left">
 		<img src="<?php echo $user_array['profile_pic']; ?>" width=35px>
...
<div class="profile_main_column column">
	 ...
	 <ul class="nav nav-tabs" role="tablist" id="profileTabs">
		...
		<!-- <ul class="nav nav-tabs" role="tablist" id="profileTabs">
			<li role="presentation" class="active"><a href="#newsfeed_div" aria-controls="newsfeed_div" role="tab" data-toggle="tab">Profiles</a></li>
