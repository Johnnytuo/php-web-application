...
class Notification {
	...
	public function insertNotification($post_id, $user_to, $type) {
		...
		// $insert_query = mysqli_query($this->con, "INSERT INTO notifications VALUES('', '03', '00', 'xxx', 'xxx', '00', 'no', 'no')");
	...
	public function getUnreadNumber() {
		// $insert_query = mysqli_query($this->con, "INSERT INTO notifications VALUES('', '04', '00', 'xxx', 'xxx', '00', 'no', 'no')");
		$userLoggedIn = $this->user_obj->getUsername();
