    ...
    public function loadPostsFriends($data, $limit){
            ...
            if(mysqli_num_rows($data_query)>0){
                ...
                while($row =mysqli_fetch_array($data_query)){
                    ...
                    //prepare user_to to string
                    if($row['user_to']=="none"){
                        $user_to="";
                    }else{

                        $user_to_bj = new User($this->con,$row['user_to']);
                        $user_to_name = $user_to_bj->getFirstAndLastName();
                    ...
                    $start_date = new Datetime($date_time);//post time
                    ...
                    $str .="<div class ='status_post' >
                                ...
                                <div class='posted_by' style='color:#ACACAC;'>
                                    ...
                                    <div class='newsfeedPostOptions'>
                                        <a href='javascript:toggle$id()'>Comments($comments_check_num)&nbsp;&nbsp;&nbsp;&nbsp;</a>
